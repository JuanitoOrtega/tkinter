...
class Login:
    ...
    def __init__(self,ventana_login):
        ...
        "--------------- Loginlogo --------------------"
        imagen_login=Image.open("img/login.png")
        ...
        "--------------- Botones --------------------"
        boton_ingresar=Button(frame_botones,text="INGRESAR",command=self.Login,height=2,width=12,bg="green",fg="black",font=("Comic Sans", 10,"bold")).grid(row=0, column=1, padx=10, pady=15)
        boton_registrar=Button(frame_botones,text="REGISTRAR",command=self.LLamar_registro,height=2,width=12,bg="blue",fg="black",font=("Comic Sans", 10,"bold")).grid(row=0, column=2, padx=10, pady=15)
        label_=Label(frame_botones,text="⬇ ¿Olvido su contraseña? ⬇",font=("Comic Sans", 10,"bold")).grid(row=1,column=1,columnspan=2,sticky='s')
        boton_olvido=Button(frame_botones,text="RECUPERAR CONTRASEÑA",command=self.LLamar_recuperar ,height=2,width=24,bg="gray",fg="black",font=("Comic Sans", 10,"bold")).grid(row=2, column=1, columnspan=2, padx=10, pady=8)
    ...
    def LLamar_registro(self):
        ...
        subprocess.call([sys.executable, '1-Formulario_registro.py', 'htmlfilename.htm'])

    #call recuperar
    def LLamar_recuperar(self):
        ventana_login.destroy()
        subprocess.call([sys.executable, '3-Recuperar_password.py', 'htmlfilename.htm'])
