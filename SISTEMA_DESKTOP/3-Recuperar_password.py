...
class Recuperar_contraseña:
    ...
    def __init__(self, ventana_recuperar):
        ...
        imagen_password=Image.open("img/recuperar_contraseña.png")
        ...
        "--------------- Botones --------------------"
        boton_recuperar=Button(frame_botones,text="RECUPERAR",command=self.Restablecer_contraseña ,height=2,width=10,bg="green",fg="black",font=("Comic Sans", 10,"bold")).grid(row=0, column=1, padx=10, pady=10)
        boton_cancelar=Button(frame_botones,text="CANCELAR",command=self.LLamar_login ,height=2,width=10,bg="red",fg="black",font=("Comic Sans", 10,"bold")).grid(row=0, column=3, padx=10, pady=10)
    ...
    def LLamar_login(self):
        ...
        call([sys.executable, '2-Login.py', 'htmlfilename.htm'])
