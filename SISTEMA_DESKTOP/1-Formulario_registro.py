...
class Registro:
    ...
    def __init__(self,vetana):
        ...
        "--------------- Nuevo usuario logo --------------------"
        imagen_registro=Image.open("img/nuevo_usuario.png")
        ...
        "--------------- Botones --------------------"
        boton_registrar=Button(frame_botones,text="REGISTRAR",command=self.Registrar_usuario ,height=2,width=10,bg="green",fg="black",font=("Comic Sans", 10,"bold")).grid(row=0, column=1, padx=10, pady=15)
        boton_limpiar=Button(frame_botones,text="LIMPIAR",command=self.Limpiar_formulario ,height=2,width=10,bg="gray",fg="black",font=("Comic Sans", 10,"bold")).grid(row=0, column=2, padx=10, pady=15)
        boton_cancelar=Button(frame_botones,text="CERRAR",command=ventana.quit ,height=2,width=10,bg="red",fg="black",font=("Comic Sans", 10,"bold")).grid(row=0, column=3, padx=10, pady=15)
