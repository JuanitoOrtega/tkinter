...
class Producto():
    ...
    def __init__(self, ventana_producto):
        ...
        ventana_producto.geometry("769x700")
    ...
    def widgets_crud(self):
        ...
        #Logo arduino
        imagen_arduino=Image.open("img/arduino-logo.png")
        ...
        #Logo raspberry
        imagen_raspberry=Image.open("img/raspberry-logo.png")
        ...
        "--------------- Botones --------------------"
        boton_registrar=Button(self.frame_botones_registro,text="REGISTRAR",command=self.Agregar_producto,height=2,width=12,bg="green",fg="black",font=("Comic Sans", 10,"bold")).grid(row=0, column=1, padx=10, pady=15)
        boton_editar=Button(self.frame_botones_registro,text="EDITAR",command=self.Editar_producto ,height=2,width=12,bg="gray",fg="black",font=("Comic Sans", 10,"bold")).grid(row=0, column=2, padx=10, pady=15)
        boton_eliminar=Button(self.frame_botones_registro,text="ELIMINAR",command=self.Eliminar_producto,height=2,width=12,bg="red",fg="black",font=("Comic Sans", 10,"bold")).grid(row=0, column=3, padx=10, pady=15)
    ...
    def widgets_buscador(self):
        ...
        "--------------- Boton --------------------"
        self.boton_buscar=Button(self.frame_boton_buscar,text="BUSCAR",command=self.Buscar_productos,height=2,width=20,bg="black",fg="black",font=("Comic Sans", 10,"bold"))
    ...
    def widgets_informacion(self):
        ...
        "--------------- Logos imagenes--------------------"
        #Logo
        imagen_arduino=Image.open("img/app_logo_2.png")
        nueva_imagen=imagen_arduino.resize((120,120))
        render=ImageTk.PhotoImage(nueva_imagen)
    ...
    def Editar_producto(self):
        ...
        boton_actualizar=Button(self.Ventana_editar,text="ACTUALIZAR",command= lambda: self.Actualizar(nuevo_codigo.get(),nuevo_nombre.get(),nuevo_combo_categoria.get(),nueva_cantidad.get(),nuevo_precio.get(),nueva_descripcion.get(),codigo,nombre),height=2,width=20,bg="black",fg="black",font=("Comic Sans", 10,"bold"))
